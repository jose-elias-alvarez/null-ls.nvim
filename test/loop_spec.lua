...
describe("loop", function()
    ...
    describe("timer", function()
        ...
        before_each(function() uv.new_timer.returns(mock_timer) end)
        after_each(function()
            start:clear()
            stop:clear()
        end)
        ...
        it("should call uv timer start method on start", function()
            ...
            assert.stub(start).was_called_with(timeout, interval, callback)
        end)
        ...
        it("should default interval to 0 when nil", function()
            ...
            assert.stub(start).was_called_with(timeout, 0, callback)
        end)
        ...
        describe("restart", function()
            it("should restart timer with original interval and callback",
               function()
                local timer = loop.timer(timeout, interval, false, callback)
